...
运动控制目录不得依赖 WinForms 或直接弹窗，`Automation.Core.Tests/Architecture/ArchitectureBoundaryRegression.ps1` 对该边界提供门禁。界面提示由 `ManualMotionService.CommandRejected` 和 UI 适配层处理。
