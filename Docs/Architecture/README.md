...
| --- | --- | --- | --- |
| 进程入口 | [`Program.cs`](../../Program.cs) | 启动准备、选择 HMI 或编辑器、运行消息循环 | 业务配置和设备细节 |
| 生命周期宿主 | [`Runtime/AutomationPlatformHost.cs`](../../Runtime/AutomationPlatformHost.cs) | 单实例状态、SDK、初始化和安全关闭 | 直接实现流程指令 |
...
| 流程结构可保存性 | [`Engine/ProcessDefinitionService.cs`](../../Engine/ProcessDefinitionService.cs) |
| 流程可运行性 | [`Engine/ProcessReadinessService.cs`](../../Engine/ProcessReadinessService.cs)和实际启动闸门 |
| 生命周期状态 | [`Runtime/AutomationPlatformHost.cs`](../../Runtime/AutomationPlatformHost.cs) |
| 配置文件默认值与校验 | 对应 `Runtime/*ConfigStorage.cs`、`Stores/*Store.cs` |
