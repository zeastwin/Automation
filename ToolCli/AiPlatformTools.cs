...
{
    public static class AiPlatformTools
    {
        // CLI 为一次性进程，Bridge 客户端经固定命名管道直连主程序。
        private static readonly AutomationBridgeClient BridgeClient = new AutomationBridgeClient();

        [AiTool(Name = "get_native_operation_schemas"), Description(
        ...
        [AiTool(Name = "get_semantic_operation_schema"), Description(
        ...
        [AiTool(Name = "preview_change_set"), Description(
        ...
        [AiTool(Name = "apply_change_set"), Description(
        ...
        [AiTool(Name = "discard_change_set_preview"), Description(
        ...
        [AiTool(Name = "get_platform_development_context"), Description(
        ...
        [AiTool(Name = "get_process_design_guide"), Description(
        ...
        [AiTool(Name = "list_procs"), Description(
        ...
        [AiTool(Name = "search_proc_catalog"), Description(
        ...
        [AiTool(Name = "get_proc_overview"), Description(
        ...
        [AiTool(Name = "get_proc_detail"), Description(
        ...
        [AiTool(Name = "get_flow_graph"), Description(
        ...
        [AiTool(Name = "get_op_detail"), Description(
        ...
        [AiTool(Name = "get_op_details"), Description(
        ...
        [AiTool(Name = "get_step_detail"), Description(
        ...
        [AiTool(Name = "search_ops"), Description(
        ...
        [AiTool(Name = "get_operation_references"), Description(
        ...
        [AiTool(Name = "get_proc_references"), Description(
        ...
        [AiTool(Name = "trace_resource"), Description(
        ...
        [AiTool(Name = "get_communication"), Description(
        ...
        [AiTool(Name = "list_plc_devices"), Description(
        ...
        [AiTool(Name = "get_plc_device"), Description(
        ...
        [AiTool(Name = "search_operation_fields"), Description(
        ...
        [AiTool(Name = "find_references"), Description(
        ...
        [AiTool(Name = "find_variable_usages"), Description(
        ...
        [AiTool(Name = "get_operation_context"), Description(
        ...
        [AiTool(Name = "audit_proc_batch"), Description(
        ...
        [AiTool(Name = "diagnose_issue"), Description(
        ...
        [AiTool(Name = "get_snapshot"), Description(
        ...
        [AiTool(Name = "wait_for_proc_state"), Description(
        ...
        [AiTool(Name = "run_proc_test"), Description(
        ...
        [AiTool(Name = "list_operation_types"), Description(
        ...
        [AiTool(Name = "get_operation_schema"), Description(
        ...
        [AiTool(Name = "get_operation_guide"), Description(
        ...
        [AiTool(Name = "get_info_log_tail"), Description(
        ...
        [AiTool(Name = "diagnose_proc"), Description(
        ...
        [AiTool(Name = "validate_proc"), Description(
        ...
        [AiTool(Name = "start_proc"), Description(
        ...
        [AiTool(Name = "stop_proc"), Description(
        ...
        [AiTool(Name = "pause_proc"), Description(
            "暂停流程。不需要预演确认，直接发送命令。"
            + "要求流程处于 Running 状态。")]
        ...
        [AiTool(Name = "resume_proc"), Description(
        ...
        [AiTool(Name = "list_variables"), Description(
        ...
        [AiTool(Name = "get_variable_by_name"), Description(
        ...
        [AiTool(Name = "get_variable_by_index"), Description(
        ...
        [AiTool(Name = "set_variable_by_name"), Description(
        ...
        [AiTool(Name = "set_variable_by_index"), Description(
        ...
        [AiTool(Name = "delete_variable"), Description(
        ...
        [AiTool(Name = "add_variable"), Description(
            "创建一个新变量，要求所有流程已停止。"
        ...
        [AiTool(Name = "update_variable"), Description(
        ...
        [AiTool(Name = "list_stations"), Description(
        ...
        [AiTool(Name = "get_station"), Description(
        ...
        [AiTool(Name = "list_points"), Description(
        ...
        [AiTool(Name = "get_point"), Description(
        ...
        [AiTool(Name = "list_data_structs"), Description(
            "列出全部数据结构名称及各自数据项数量。"
        ...
        [AiTool(Name = "get_data_struct"), Description(
        ...
        [AiTool(Name = "search_data_struct_items"), Description(
            "在一个已知数据结构内搜索其数据项。"
        ...
        [AiTool(Name = "upsert_data_struct"), Description(
        ...
        [AiTool(Name = "delete_data_struct"), Description(
        ...
        [AiTool(Name = "get_migration_configuration"), Description(
        ...
        [AiTool(Name = "preview_motion_io_configuration"), Description(
        ...
        [AiTool(Name = "preview_io_debug_configuration"), Description(
        ...
        [AiTool(Name = "preview_plc_configuration"), Description(
        ...
        [AiTool(Name = "preview_communication_configuration"), Description(
        ...
        [AiTool(Name = "apply_migration_configuration"), Description(
        ...
        [AiTool(Name = "discard_migration_configuration"), Description(
        ...
        [AiTool(Name = "validate_platform_configuration"), Description(
        ...
        [AiTool(Name = "list_io"), Description(
        ...
        [AiTool(Name = "get_io"), Description(
        ...
        [AiTool(Name = "search_io"), Description(
        ...
        [AiTool(Name = "get_io_state"), Description(
        ...
        [AiTool(Name = "search_alarms"), Description(
        ...
        [AiTool(Name = "get_alarm"), Description(
        ...
        [AiTool(Name = "set_alarm"), Description(
        ...
        [AiTool(Name = "delete_alarm"), Description(
            ...
            Func<AutomationBridgeClient, Task<string>> action)
        {
            ...
            try
            {
                string result = await action(BridgeClient).ConfigureAwait(false);
                stopwatch.Stop();
